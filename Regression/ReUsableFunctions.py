...
path = 'E:/Data Science/Data/'
house_train = pd.read_csv(os.path.join(path,"MediaSpendData_SJilla.csv"))
house_train.shape
house_train.info()
...
features_to_drop = ['year', 'month']
features_to_drop.extend(get_features_to_drop_on_missingdata(house_train, 0.001))
